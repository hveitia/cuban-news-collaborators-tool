...
const profiles = [
  {label: 'First Name', value: 'Jone'},
  {label: 'Last Name', value: 'Doe'},
  {label: 'Email', value: 'Jone@gmail.com'},
  {label: 'Phone Number', value: '+1546820457'},
  {label: 'Address', value: 'USA'},
  {label: 'Zip Code', value: '145852'},
  {label: 'status', value: 'Admin'},
  {label: 'Active Status', value: 'Active'},
  {label: 'Date of Birth', value: '30/12/1997'},
  {label: 'Zip Code', value: '145852'},
  {label: 'status', value: 'Admin'},
  {label: 'Active Status', value: 'Active'},
]
...
const ProfilePage = () => {
  ...
  return (
    <Fragment>
      ...
      <h2 className="breadcumbTitle">Profile Page</h2>
