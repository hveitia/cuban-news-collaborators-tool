...
import EnhancedTable from './components/sortingSelecting'
import CustomizedTables from './components/CustomizedTables'
import CustomPaginationActionsTable from './components/customTablePaginationAction'
...
const MaterialTable = () => {
  return (
    <Fragment>
      ...
      <h2 className="breadcumbTitle">Material Table</h2>
